...
import { RegisterBookApplicationService, RegisterBookCommand } from './RegisterBookApplicationService'
...
describe('RegisterBookApplicationService', () => {
  it('重複書籍が存在しない場合書籍が正常に作成できる', async () => {
    ...
    const registerBookApplicationService = new RegisterBookApplicationService(repository, mockTransactionManager)
